...
%w{apache2 cookbook_appbox build-essential cookbook_databox htpasswd newrelic nginx php php-fpm rackspace_cloudbackup rackspace_cloudmonitoring ssmtp}.each do |cb|
  depends cb
end