...
if node['cookbook_phpbox']['rackspace']

  rackspace_username = node['cookbook_phpbox']['rackspace']['username']
  rackspace_api_key = node['cookbook_phpbox']['rackspace']['api_key']
  rackspace_monitoring = node['cookbook_phpbox']['rackspace']['monitoring']
  rackspace_backup = node['cookbook_phpbox']['rackspace']['backup']
